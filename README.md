Welcome to the README for our counterfeit detection system: a supply chain management app, built using Flutter for the front-end and NodeJS for the back-end.
